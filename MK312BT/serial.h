/*
 * serial.h - MK-312BT Serial Communication Protocol
 *
...
void serial_enable_rx_interrupt(void);                          /* Enable USART RX interrupt */
...
void serial_reset_encryption(void);                                /* Reset encryption state for reconnect */
